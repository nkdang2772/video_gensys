...
- Lỗi đang mở: **0**
- Lỗi đã đóng: **40**
- Test regression gần nhất trên `main`: **122/122 pass** (Bước 18, PR #19, merge commit `d779578`)
- Bước 19 trên branch `codex/step19-revalidation`: targeted **3/3 pass**, full regression **123/123 pass**.
