...
- Lỗi đang mở: **0**
- Lỗi đã đóng: **38**
- Test regression gần nhất trên `main`: **109/109 pass** (Bước 13, PR #13, merge commit `dab009d`)
- Bước 14 trên branch `codex/step14-revalidation`: targeted **8/8 pass**, full regression **114/114 pass**
