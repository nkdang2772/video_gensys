...
- Lỗi đang mở: **0**
- Lỗi đã đóng: **40**
- Test regression gần nhất trên `main`: **120/120 pass** (Bước 17, PR #18, merge commit `b756804`)
- Bước 18 trên branch `codex/step18-revalidation`: targeted **15/15 pass**, full regression **122/122 pass**.
