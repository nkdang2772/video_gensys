...
**Gate chính thức:** **Bước 1–17 — PASS; Bước 18 — đang revalidate**
**Trạng thái:** Code lịch sử tồn tại đến Bước 30, nhưng chỉ Bước 1–17 đã đủ branch/PR/CI/merge để được đánh PASS chính thức. Bước 18 đã đạt test local nhưng chưa được đánh PASS trước khi có PR, CI xanh và merge; Bước 19 chưa được bắt đầu.
...
- **Bước 18 đang revalidate** trên branch `codex/step18-revalidation`: AppTest tạo 6 character reference series-specific qua UI, thêm version v1 cho từng reference, tạo Episode và xác nhận đủ 6 `EpisodeReferencePin`; thiếu source version hiển thị lỗi và không tạo `ReferenceVersion`. Targeted **15/15 pass**, full regression **122/122 pass**; PR/CI/merge còn chờ.
- Các mô tả “đã hoàn thành” bên dưới là inventory implementation lịch sử, không phải dấu check DoD cho Bước 18–30.
