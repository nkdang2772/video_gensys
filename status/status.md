...
**Gate chính thức:** **Bước 1–15 — PASS; Bước 16 — đang revalidate**
**Trạng thái:** Code lịch sử tồn tại đến Bước 30, nhưng chỉ Bước 1–15 đã đủ branch/PR/CI/merge để được đánh PASS chính thức. Bước 16 đã đạt test local nhưng chưa được đánh PASS trước khi có PR, CI xanh và merge; Bước 17 chưa được bắt đầu.
...
- **Bước 16 đang revalidate** trên branch `codex/step16-revalidation`: AppTest import script và **80/80 WAV** qua UI, hiển thị shot list 80 dòng; thiếu script hiển thị lỗi và không tạo Shot. BUG-039 đã đóng bằng retry giới hạn cho FFprobe timeout; targeted liên quan **18/18 pass**, full regression **117/117 pass**; PR/CI/merge còn chờ.
- Các mô tả “đã hoàn thành” bên dưới là inventory implementation lịch sử, không phải dấu check DoD cho Bước 16–30.
